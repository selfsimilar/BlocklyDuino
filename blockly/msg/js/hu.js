...
Blockly.Msg.SHIELD_BOT_BACKWARD_TITLE = "Backward";  // untranslated
Blockly.Msg.SHIELD_BOT_BACKWARD_TOOLTIP = "Enables the motors to send the bot straight backward at the setSpeed().";  // untranslated
...
Blockly.Msg.SHIELD_BOT_FORWARD_TITLE = "Forward";  // untranslated
Blockly.Msg.SHIELD_BOT_FORWARD_TOOLTIP = "Enables the motors to send the bot straight forward at the setSpeed().";  // untranslated
Blockly.Msg.SHIELD_BOT_HELPURL = "http://www.seeedstudio.com/wiki/Shield_Bot_V1.2";  // untranslated
Blockly.Msg.SHIELD_BOT_LEFT_MOTOR_TITLE = "Control Left motor";  // untranslated
Blockly.Msg.SHIELD_BOT_LEFT_MOTOR_TOOLTIP = "Enables the left motor, negative for backwards, positive for forwards.";  // untranslated
...
Blockly.Msg.SHIELD_BOT_RIGHT_MOTOR_TITLE = "Control Right motor";  // untranslated
Blockly.Msg.SHIELD_BOT_RIGHT_MOTOR_TOOLTIP = "Enables the right motor, negative for backwards, positive for forwards.";  // untranslated
...
Blockly.Msg.SHIELD_BOT_STOPLEFT_TITLE = "StopLeft";  // untranslated
Blockly.Msg.SHIELD_BOT_STOPLEFT_TOOLTIP = "Disables the left motor. You may also use drive(0,X).";  // untranslated
Blockly.Msg.SHIELD_BOT_STOPRIGHT_TITLE = "StopRight";  // untranslated
Blockly.Msg.SHIELD_BOT_STOPRIGHT_TOOLTIP = "Disables the right motor. You may also use drive(X,0).";  // untranslated
Blockly.Msg.SHIELD_BOT_STOP_TITLE = "Stop";  // untranslated
Blockly.Msg.SHIELD_BOT_STOP_TOOLTIP = "Disables the motors. You may also use drive(0,0).";  // untranslated
