...
Blockly.Msg.CATEGORY_COMMUNICATION = "Communication";  // untranslated
Blockly.Msg.CATEGORY_CONTROL = "Control";  // untranslated
...
Blockly.Msg.COMMUNICATION_SERIAL_AVAILABLE_APPENDTEXT = "Serial Available";  // untranslated
Blockly.Msg.COMMUNICATION_SERIAL_AVAILABLE_HELPURL = "http://www.arduino.cc/en/Serial/available";  // untranslated
Blockly.Msg.COMMUNICATION_SERIAL_AVAILABLE_TOOLTIP = "Get the number of bytes (characters) available for reading from the serial port.";  // untranslated
Blockly.Msg.COMMUNICATION_SERIAL_PRINTLN_APPENDTEXT = "Serial Println";  // untranslated
Blockly.Msg.COMMUNICATION_SERIAL_PRINTLN_HELPURL = "http://www.arduino.cc/en/Serial/Println";  // untranslated
Blockly.Msg.COMMUNICATION_SERIAL_PRINTLN_TOOLTIP = "Prints data to the serial port as human-readable ASCII text followed by a carriage return character and a newline characte.";  // untranslated
Blockly.Msg.COMMUNICATION_SERIAL_PRINT_APPENDTEXT = "Serial Print";  // untranslated
Blockly.Msg.COMMUNICATION_SERIAL_PRINT_HELPURL = "http://www.arduino.cc/en/Serial/Print";  // untranslated
Blockly.Msg.COMMUNICATION_SERIAL_PRINT_TOOLTIP = "Prints data to the console/serial port as human-readable ASCII text.";  // untranslated
Blockly.Msg.COMMUNICATION_SERIAL_READ_APPENDTEXT = "Serial Read";  // untranslated
Blockly.Msg.COMMUNICATION_SERIAL_READ_HELPURL = "http://www.arduino.cc/en/Serial/Read";  // untranslated
Blockly.Msg.COMMUNICATION_SERIAL_READ_TOOLTIP = "the first byte of incoming serial data available (or -1 if no data is available).";  // untranslated
...
Blockly.Msg.INOUT_DIGITAL_READ_APPENDTEXT = "DigitalRead PIN#";  // untranslated
