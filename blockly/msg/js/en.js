...
Blockly.Msg.COMMUNICATION_SERIAL_AVAILABLE_APPENDTEXT = "Serial Available";
Blockly.Msg.COMMUNICATION_SERIAL_AVAILABLE_HELPURL = "http://www.arduino.cc/en/Serial/available";
Blockly.Msg.COMMUNICATION_SERIAL_AVAILABLE_TOOLTIP = "Get the number of bytes (characters) available for reading from the serial port.";
Blockly.Msg.COMMUNICATION_SERIAL_PRINTLN_APPENDTEXT = "Serial Println";
Blockly.Msg.COMMUNICATION_SERIAL_PRINTLN_HELPURL = "http://www.arduino.cc/en/Serial/Println";
Blockly.Msg.COMMUNICATION_SERIAL_PRINTLN_TOOLTIP = "Prints data to the serial port as human-readable ASCII text followed by a carriage return character and a newline characte.";
Blockly.Msg.COMMUNICATION_SERIAL_PRINT_APPENDTEXT = "Serial Print";
Blockly.Msg.COMMUNICATION_SERIAL_PRINT_HELPURL = "http://www.arduino.cc/en/Serial/Print";
Blockly.Msg.COMMUNICATION_SERIAL_PRINT_TOOLTIP = "Prints data to the console/serial port as human-readable ASCII text.";
Blockly.Msg.COMMUNICATION_SERIAL_READ_APPENDTEXT = "Serial Read";
Blockly.Msg.COMMUNICATION_SERIAL_READ_HELPURL = "http://www.arduino.cc/en/Serial/Read";
Blockly.Msg.COMMUNICATION_SERIAL_READ_TOOLTIP = "the first byte of incoming serial data available (or -1 if no data is available).";
...
Blockly.Msg.INOUT_DIGITAL_READ_APPENDTEXT = "DigitalRead PIN#";
